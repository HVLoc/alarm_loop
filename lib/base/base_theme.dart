...
ThemeData _getThemeDarkOrLight(ThemeData base, {bool isDarkMode = true}) {
  return base.copyWith(
      ...
      scaffoldBackgroundColor:
          isDarkMode ? AppColors.darkAccentColor : Colors.red,
...
TextTheme _basicTextTheme(ThemeData base, {bool isDarkMode = true}) {
  ...
  Color subTextColor = isDarkMode ? Colors.white54 : Colors.black87;
  return base.textTheme.copyWith(
    ...
    // subtitle
    subtitle1: _textTheme.subtitle1.copyWith(fontSize: 14, color: textColor),
    subtitle2: _textTheme.subtitle2.copyWith(fontSize: 12, color: subTextColor),
    // body
    bodyText1: _textTheme.bodyText1.copyWith(fontSize: 16, color: textColor),
    bodyText2: _textTheme.bodyText2.copyWith(fontSize: 14, color: subTextColor),
